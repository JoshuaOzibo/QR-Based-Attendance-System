...
export const exploreCommunity = (startNode, graph, depth, algorithm) => {
    // simplified mock wrapper to match server.js usage
    return algorithm === 'dfs' ? dfs(graph, startNode) : bfs(graph, startNode);
};
