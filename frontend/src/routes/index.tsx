    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          <div className="absolute -top-32 right-0 -z-10 h-[400px] sm:h-[600px] w-[400px] sm:w-[600px] rounded-full bg-primary/15 blur-[100px] sm:blur-[140px]" />
          <div className="absolute -bottom-24 left-0 -z-10 h-[350px] sm:h-[500px] w-[350px] sm:w-[500px] rounded-full bg-chart-5/10 blur-[90px] sm:blur-[120px]" />
          ...
          <div className="mx-auto grid max-w-7xl gap-10 sm:gap-14 lg:gap-16 px-4 sm:px-6 pt-8 sm:pt-16 lg:pt-20 pb-12 sm:pb-24 lg:grid-cols-[1.1fr_1fr] lg:items-center">
            <div className="animate-float-up text-center sm:text-left flex flex-col items-center sm:items-start">
              <div className="mb-4 sm:mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3.5 py-1.5">
                <span className="size-2 animate-pulse rounded-full bg-primary shrink-0" />
                <span className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.18em] text-primary truncate">
                  Active Session · CS-402 Systems Architecture
                </span>
              </div>

              <h1 className="text-balance text-3xl min-[400px]:text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.15]">
                Dynamic verification for the <span className="text-gradient">modern university</span>.
              </h1>

              <p className="mt-4 sm:mt-6 max-w-[58ch] text-balance text-sm sm:text-base lg:text-lg leading-relaxed text-muted-foreground">
              ...
              <div className="mt-6 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 w-full sm:w-auto">
                <Link
                  to="/login"
              ...
              <div className="mt-8 sm:mt-12 flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6 text-xs text-muted-foreground border-t border-border/40 pt-6 w-full">
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-20">
          <div className="mb-8 sm:mb-12 max-w-2xl text-center sm:text-left">
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-16 sm:pb-24">
          <div className="relative overflow-hidden rounded-3xl border border-border glass-strong p-6 sm:p-10 lg:p-12">
