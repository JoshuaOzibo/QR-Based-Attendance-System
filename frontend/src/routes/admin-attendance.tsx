    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-background">
      ...
      <div className="min-w-0 flex-1">
        <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10 lg:p-10">
          <header className="mb-6 sm:mb-10">
            ...
            <h1 className="mt-1 sm:mt-2 text-2xl sm:text-4xl font-semibold tracking-tight">Attendance History</h1>
            <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-muted-foreground">View past classes and manage student attendance records.</p>
          </header>
      ...
      {selectedSession && (
        <div className="fixed inset-0 z-50 flex items-stretch justify-end bg-background/70 backdrop-blur-sm">
          ...
          {/* Panel — full height, responsive width, internal scroll */}
          <div className="bg-card w-full sm:max-w-2xl h-full flex flex-col border-l border-border shadow-2xl">
            ...
            <div className="flex items-start justify-between px-4 sm:px-6 py-4 sm:py-5 border-b border-border shrink-0">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h2 className="text-base sm:text-lg font-semibold">Attendees List</h2>
                </div>
              ...
              <button 
                ...
                className="p-1.5 hover:bg-muted rounded-md text-muted-foreground hover:text-foreground transition-colors mt-0.5"
              >
                <X className="size-5" />
              </button>
            </div>
            ...
            {/* ── Search + Download bar ─────────────────────────────────────── */}
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-border shrink-0 flex items-center gap-2 sm:gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-border bg-background/60 pl-9 pr-3 py-2 text-xs sm:text-sm outline-none transition-colors placeholder:text-muted-foreground/60 focus:border-primary/60 focus:ring-2 focus:ring-primary/20"
                />
              </div>
              <button
                onClick={downloadPDF}
                disabled={!attendanceList?.length}
                className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-primary-foreground hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed shrink-0"
              >
